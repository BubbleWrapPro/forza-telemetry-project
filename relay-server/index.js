...
const suspensionTravel = { fl: msg.readFloatLE(68), fr: msg.readFloatLE(72), rl: msg.readFloatLE(76), rr: msg.readFloatLE(80) };
...
? Object.fromEntries(Object.entries(suspensionTravel).map(([wheel, travel]) => [wheel, (travel - previousSuspension.values[wheel]) / deltaSeconds]))
: { fl: 0, fr: 0, rl: 0, rr: 0 };
previousSuspension = { timestampMs, values: suspensionTravel };
...
tireWear: {
fl: msg.readFloatLE(188), fr: msg.readFloatLE(192),
rl: msg.readFloatLE(196), rr: msg.readFloatLE(200)
},
tireDeformation: {
...
suspensionRebound: {
fl: msg.readFloatLE(116), fr: msg.readFloatLE(120),
rl: msg.readFloatLE(124), rr: msg.readFloatLE(128)
},
